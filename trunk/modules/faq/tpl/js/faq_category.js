/**
 * @file   modules/faq/tpl/js/faq_category.js
 * @author NHN (developers@xpressengine.com)
 * @brief  faq module category tree javascript
 **/
    ...
    jQuery.get(url,function(data){
        ...
        simpleTreeCollection = jQuery('.simpleTree').simpleTree({
            ...
            afterMove:function(destination, source, pos){
                ...
                jQuery.exec_json("faq.procFaqMoveCategory",{ "module_srl":module_srl,"parent_srl":parent_srl,"target_srl":target_srl,"source_srl":source_srl},
                function(data){
                    jQuery('#category_info').html('');
...
function addNode(node,e){
    ...
    jQuery.exec_json('faq.getFaqCategoryTplInfo', params, function(data){
...
function deleteNode(node){
    if(confirm(lang_confirm_delete)){
        ...
        jQuery.exec_json('faq.procFaqDeleteCategory', params, function(data){
            if(data.error==0) Tree(xml_url);
        });
    }
}
