    ...
    class faqView extends faq {
        ...
        function dispFaqCategoryList(){
			if($this->module_info->use_category=='Y') {
				...
				$category_list = $oFaqModel->getCategoryList($this->module_srl);
        ...
        function dispFaqContentList(){
			...
			if($output->data){
				foreach($output->data as $question_item){
					...
					$question_list[$question_item->question_srl]->question = $this->xss_clean($question_item->getQuestion());
					$question_list[$question_item->question_srl]->answer = $this->xss_clean($question_item->getAnswer());
				}
			}
        ...
        function dispFaqWrite() {
			...
			if($this->module_info->use_category=='Y') {
				...
				$normal_category_list = $oFaqModel->getCategoryList($this->module_srl);
